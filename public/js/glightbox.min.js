    ...
    var t,
      ...
      q = new B(z, {
        touchStart: function (t) {
          if (g(t.targetTouches[0].target, 'ginner-container') || v(t.targetTouches[0].target, '.gslide-desc'))
            return (r = !1), !1;
          (r = !0),
            (P = t.targetTouches[0]),
  ...
  function R(e, t, i) {
    ...
    'file' == c && (c = 'http'),
      ...
      T(this.settings.plyr.js, 'Plyr', function () {
        ...
        var y =
          v ||
          x('<div id="'.concat(l, '" data-plyr-provider="').concat(u, '" data-plyr-embed-id="').concat(g, '"></div>'));
            ...
            value: function () {
              ...
              if (
                (C(n.afterSlideLoad) &&
                  (v = function () {
                    C(i) && i(),
                      n.afterSlideLoad({index: s.index, slide: t, player: e.instance.getSlidePlayerInstance(s.index)});
                  }),
            ...
            value: function () {
              ...
              if ((e = e || this.activeSlide) && !g(e, 'zoomed')) {
                ...
                if ((l <= 768 ? d(document.body, 'glightbox-mobile') : u(document.body, 'glightbox-mobile'), i || n)) {
                  var r = !1;
                  if (
                    (s && (g(s, 'description-bottom') || g(s, 'description-top')) && !g(s, 'gabsolute') && (r = !0), n)
                  )
                    if (l <= 768) {
