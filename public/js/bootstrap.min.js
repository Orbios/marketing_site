    ...
    _ = function (t, e, n) {
      Object.keys(n).forEach(function (i) {
        ...
        if (!new RegExp(s).test(a))
          throw new Error(
            t.toUpperCase() + ': Option "' + i + '" provided type "' + a + '" but expected type "' + s + '".'
          );
      });
    },
    v = function (t) {
  ...
  var q = {
    ...
    et = (function (t) {
      ...
      return (
        ...
        (n.pause = function (t) {
          t || (this._isPaused = !0),
            V.findOne('.carousel-item-next, .carousel-item-prev', this._element) && (p(this._element), this.cycle(!0)),
          ...
          if (
            ...
            if (
              ...
              r.classList.remove('active'),
                l.classList.add('active'),
                (this._isSliding = !1),
                Q.trigger(this._element, 'slid.bs.carousel', {relatedTarget: l, direction: o, from: a, to: c});
            u && this.cycle();
          }
        }),
      ...
      return (
        ...
        (a._getPopperConfig = function () {
          var t = {
            ...
            modifiers: [
              {name: 'preventOverflow', options: {altBoundary: this._config.flip, rootBoundary: this._config.boundary}}
            ]
          };
          return (
      ...
      return (
        ...
        (n._resetScrollbar = function () {
          ...
          void 0 === t
            ...
            : (q.removeDataAttribute(document.body, 'padding-right'), (document.body.style.paddingRight = t));
        }),
      ...
      return (
        ...
        (a.setElementContent = function (t, e) {
          if (null !== t)
            return 'object' == typeof e && g(e)
              ...
              : void (this.config.html
                  ? (this.config.sanitize && (e = kt(e, this.config.allowList, this.config.sanitizeFn)),
                    (t.innerHTML = e))
                  : (t.textContent = e));
        }),
        (a.getTitle = function () {
        ...
        (a._enter = function (t, e) {
          ...
          (e = e || L(t.delegateTarget, n)) ||
            ((e = new this.constructor(t.delegateTarget, this._getDelegateConfig())), A(t.delegateTarget, n, e)),
        ...
        (a._getConfig = function (t) {
          ...
          return (
            ...
            'number' == typeof (t = s({}, this.constructor.Default, e, 'object' == typeof t && t ? t : {})).delay &&
